						...
						<div class="card mb-5">
							...
							<div class="card-body">
								...
								<form action="<?php echo base_url() ?>tiket_41518110070/cekjadwal?>" method="get">
									...
									<div class="form-group">
										<label for="exampleInputEmail1">Asal <b>(Saat Ini Baru Tersedia Pemberangkatan dari Jakarta)</b></label>
									...
									<div class="form-group">
										...
										<select name="tujuan" class="form-control js-example-basic-single">
											...
											<option value="<?php echo $row['kota_tujuan'] ?>"><?php echo strtoupper($row['kota_tujuan']).' ['.$row['nama_terminal_tujuan'].']'; ?> - <br><?php echo $row['terminal_tujuan']; ?> </option>
											<?php } ?>
										</select>
										<!-- </div> -->
									</div>
									<a href="<?php echo base_url() ?>home_41518110070" class="btn btn-primary pull-left">Kembali </a>
