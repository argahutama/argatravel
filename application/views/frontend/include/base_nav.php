<header id="header" id="home">
		    <div class="container">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="<?php echo base_url() ?>"><h3><b>Arga Travel</b></h3></a>
			      </div>
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          <li class="menu"><a href="<?php echo base_url() ?>">Home</a></li>
			          <li><a href="<?php echo base_url() ?>tiket_41518110070">Cari & Pesan Tiket</a></li>
			          <li class="menu"><a href="<?php echo base_url() ?>profile_41518110070/tiketsaya/<?php echo $this->session->userdata('kd_pelanggan') ?>">Tiket Saya</a></li>
