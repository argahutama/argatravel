            ...
            <table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                        <a class="btn btn-sm btn-default" href="<?php echo base_url(); ?>backend/grafik_41518110070/lihat_grafik_batang">Lihat Grafik</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align:center;">
                        <a class="btn btn-sm btn-default" href="<?php echo base_url(); ?>backend/grafik_41518110070/lihat_grafik_pie">Lihat Grafik</a>
                        </td>
                    </tr>
                </tbody>
            </table>
