...
class Jadwal_41518110070 extends CI_Controller {
	...
	public function index(){
		...
		$data['jadwal'] = $this->db->query("SELECT * FROM tbl_jadwal_41518110070 LEFT JOIN tbl_bus_41518110070 on tbl_jadwal_41518110070.kd_bus = tbl_bus_41518110070.kd_bus LEFT JOIN tbl_tujuan_41518110070 on tbl_jadwal_41518110070.kd_asal = tbl_tujuan_41518110070.kd_tujuan ")->result_array();
	...
	public function viewjadwal($id=''){
		$data['title'] = "List Tujuan";
	 	$sqlcek = $this->db->query("SELECT * FROM tbl_jadwal_41518110070 LEFT JOIN tbl_bus_41518110070 on tbl_jadwal_41518110070.kd_bus = tbl_bus_41518110070.kd_bus LEFT JOIN tbl_tujuan_41518110070 on tbl_jadwal_41518110070.kd_tujuan = tbl_tujuan_41518110070.kd_tujuan WHERE kd_jadwal ='".$id."'")->row_array();
	 	if ($sqlcek) {
